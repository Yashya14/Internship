...
const AddUserModal: React.FC<AddUserModalProps> = ({ show, onHide, user }) => {
    // const { getCombinedData } = useUserRoleContext();
    ...
    const validateInputFeilds = () => {
        ...
        const passwordRegex = /^(?=.*[a-z])(?=.*[A-Z])(?=.*\d).+$/; // for password
    ...
    const handleAddUser = async () => {
        ...
        if (Object.keys(validationErrors).length > 0) {
            if (user && validationErrors.password) {
        ...
        <Modal show={show} onHide={onHide} backdrop="static" size="lg">
            ...
            <Form>
                <Modal.Body className="custom-modal">
                    ...
                    <Row>
                        <Col xs={12} sm={6} lg={4}>
                            <Form.Group controlId="formPassword" className='mt-2'>
                                <Form.Label>Password<span className='required-feilds'>*</span></Form.Label>
                                <Form.Control
                                    type="password"
                                    size="sm"
                                    ...
                                    onChange={handleChange}
                                    isInvalid={!user && !!errors.password}
                                    required
                                    disabled={!!user}
                                />
                                <Form.Control.Feedback type="invalid">
                    ...
                    <Row>
                        <Col xs={12} sm={6}>
                            <Form.Group controlId="formState" className="mt-2 mb-1">
                        ...
                        <Col xs={12} sm={6}>
                            <Form.Group controlId="formCountry" className="mt-2 mb-1">
