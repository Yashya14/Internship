  ...
  useEffect(() => {
    if (id) {
      if (useLocal) {
        ...
        getSingleUser(id); // from api
      }
    } else {
      setFormData(initialState);
    }
  }, [id, localData, useLocal]);
              ...
              <div className="card-body">
                ...
                >
                  ...
                  <div className="flex justify-center py-2 max-w-sm mx-auto">
                    <button
                      className="bg-black text-white py-2 px-2 rounded-full hover:bg-gray-800 w-full sm:w-1/2 focus:outline-none focus:ring-2 focus:ring-black transition-all duration-200"
                      type="submit"
                    >
                      {id ? "Update" : "Add"}
                    </button>
