                    ...
                    <Col sm={12} md={12} lg={9} xl={7} className="d-flex flex-column flex-sm-row justify-content-start justify-content-sm-end align-items-center">
                        ...
                        <div className='d-flex flex-row justify-content-between align-items-center'>
                            <div className="d-flex flex-row">
                                <Button
                                    variant="secondary"
                                    className="d-flex align-items-center me-2 btn-sm btn-md mb-2 mb-sm-0 p-1 ms-2"
                            ...
                            <div className="d-flex flex-row">
                                <Button
                                    variant="danger"
                                    className="d-flex align-items-center me-2 btn-sm btn-md mb-2 mb-sm-0 p-1"
                            ...
                            <div className="d-flex flex-row">
                                <Button onClick={openAddModal} variant="primary" className="d-flex align-items-center me-2 btn-sm btn-md mb-2 mb-sm-0 p-1">
