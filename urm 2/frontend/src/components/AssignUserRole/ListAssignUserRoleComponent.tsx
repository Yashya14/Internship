...
const ListAssignUserRoleComponent: React.FC = () => {
    ...
    // const filteredUserRole = Array.isArray(userRole) ? userRole.filter((role) => {
    //     return (
    ...
    //         role.roleNames.some((roleName: string) => roleName.toLowerCase().includes(searchUserRole.toLowerCase()))
    //     );
    // }) : [];
            ...
            <div>
                ...
                <Row className="mt-2 mb-2">
                    <Col sm={12} md={12} lg={4} xl={5} className="d-flex justify-content-between align-items-center">
                        <h5>All roles <span className="text-muted">{userRole ? userRole.length : 0}</span></h5>
                    </Col>
                    <Col sm={12} md={12} lg={8} xl={7} className="d-flex flex-column flex-sm-row justify-content-start justify-content-sm-end align-items-center">
                        ...
                        <div className='d-flex flex-row justify-content-between align-items-center'>
                            <div className="d-flex flex-row">
                                <Button
                                    variant="secondary"
                                    className="d-flex align-items-center me-2 btn-sm btn-md mb-2 mb-sm-0 ms-2"
                            ...
                            <div className="d-flex flex-row">
                                <Button
                                    variant="danger"
                                    className="d-flex align-items-center me-2 btn-sm btn-md mb-2 mb-sm-0"
