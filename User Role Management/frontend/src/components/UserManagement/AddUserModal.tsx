...
interface AddUserModalProps {
    ...
    // onUserAdded: () => void; // Add callback function prop
}
...
const AddUserModal: React.FC<AddUserModalProps> = ({ show, onHide, user }) => {
    const { getCombinedData } = useUserRoleContext(); //! getAllUsers
    ...
    const handleAddUser = async () => {
        ...
        try {
            ...
            // getAllUsers(); //! data is not updating after update
            // getAllRoles() 
            await getCombinedData(); //! data is not updating after update
