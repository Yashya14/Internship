      ...
      <div className="container mx-auto px-6 flex justify-between items-center">
        ...
        <div className="hidden lg:flex space-x-6 items-center">
          <ul className="flex space-x-6">
            ...
            <li className="text-lg hover:text-yellow-400">
              <Link className="flex items-center" to="/adduser">
        ...
        {/* for mobile devices */}
        <div
          className={`lg:hidden ${isMobileMenuOpen ? "block" : "hidden"} absolute top-16 left-0 right-0 bg-gray-800 text-center`}
        >
          <ul className="space-y-4 py-4">
            ...
            <li className="text-lg hover:text-yellow-400">
              <Link className="flex justify-center items-center" to="/adduser">
                <FontAwesomeIcon icon={faUserPlus} className="mr-2" />
                Add User
              </Link>
            </li>
